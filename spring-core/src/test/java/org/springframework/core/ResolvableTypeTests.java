...
public class ResolvableTypeTests {
	...
	@Test
	public  void testResolvableClass(){
		ResolvableType resolvableType = ResolvableType.forClass(ResolvableClass.class);
		System.out.println(resolvableType.as(Serializable.class));
	}

	class ResolvableClass implements Serializable{
